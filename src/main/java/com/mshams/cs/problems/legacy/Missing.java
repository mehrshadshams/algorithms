...
//        System.out.println();
    ...
    ArrayList<Integer> out = m.repeatedNumber(A);
  ...
  private void swapIndex(List<Integer> A, int[] temp, int i, int j) {
    int t = A.get(i);
    temp[i] = A.get(j);
    temp[j] = t;
  }
